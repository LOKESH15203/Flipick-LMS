...
import com.ninepmfilms.mobile.R;
import com.ninepmfilms.mobile.activity.DescriptionActivity;
import com.ninepmfilms.mobile.activity.MainActivityWithLogin;
import com.ninepmfilms.mobile.activity.player.PlayerActivity;
    ...
    private void callApi(String courseID) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://lms1.flipick.com/cmwebapi/api/StudentCourseHBI/GetInstituteCourseListByStudent2",
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("StudentId" , MainActivityWithLogin.Companion.getStudentID());
